...
---
<left><img src="images/neighbour_cells.png" style="width: 200px; float:right"><h>**2. Fill sinks of the digital elevation model (DEM):** Fixes "holes" in digital elevation maps that disrupt water flow simulations. These holes (sinks) might be real (like volcanic craters) or errors in the map.
...
---
<left><img src="images/neighbour_cells.png" style="width: 200px; float:right"><h>
